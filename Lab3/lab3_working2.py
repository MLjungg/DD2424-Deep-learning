...
class Neural_network():
    ...
    def evaluateClassifier(self, X):
        ...
        if run_batch_norm:
            ...
            for layer, (w, b, gamma, beta, activation) in enumerate(zip(self.W, self.B, self.gamma, self.beta, self.activations)):
                H.append(s)
                s = np.dot(w, s) + b
...
def main():
    ...
    GD_params = {"batch_size": 100, "eta_min": 1e-5, "eta_max": 0.1, "n_s": 2250,
                 "cycles": 2, "lamda": 0, "run_batch_norm": True, "eps": 2e-52}
    # shapes = [(50, 3072), (50, 50), (10, 50)]
    #activations = ["relu", "relu", "softmax"]
    shapes = [(50, 100), (30, 50), (10, 30)]
    activations = ["relu", "relu", "softmax"]
    #shapes = [(50, 100), (30, 50), (20, 30), (20, 20), (10, 20), (10, 10), (10, 10), (10, 10), (10, 10)]
    #activations = ["relu", "relu", "relu", "relu", "relu", "relu", "relu", "relu", "softmax"]
    #activations = ["relu", "softmax"]
    #shapes = [(50, 100), (10, 50)]

    # Create network
    neural_network = Neural_network(load_all_data=False, shapes=shapes, activations=activations, GD_params=GD_params)
